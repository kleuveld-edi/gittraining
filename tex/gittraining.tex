...
\date{March 13, 2019} % Date, can be changed to a custom date
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Today we'll only look at the concepts you will need to use git, none of the more advanced stuff;
