...
\begin{enumerate}
  ...
  \only<1-2>{\item \textbf{Stage} changed file}
  \only<3->{\item \textcolor{gray}{\textbf{Stage} changed file}}
...
\frametitle{Now you!}
\begin{enumerate}
  \item Add a file to the folder where you've put your repository.
